...
class ClsHead(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.method in ['fc','matmul']:
            ...
            raise NameError
        # var = torch.var(self.fc_cls.weight,dim=1)
        # var_tot = torch.var(self.fc_cls.weight)
        # print(f'the every dim var is{var},total var:{var_tot}')
        return cls_score #,self.fc_cls.weight
    ...
    def loss(self,
             ...
             **kwargs):
        losses = dict()
        # loss_cls,loss_all,grad = self.loss_cls(
        # loss_cls,loss_all = self.loss_cls(
        #     cls_score,
        #     labels,
        #     weight,
        #     avg_factor=None,
